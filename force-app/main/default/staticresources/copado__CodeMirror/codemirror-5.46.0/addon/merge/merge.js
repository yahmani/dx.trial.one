...
(function(mod) {
  ...
  function drawConnectorsForChunk(dv, chunk, sTopOrig, sTopEdit, w) {
    ...
    if (dv.copyButtons) {
      ...
      copy.chunk = chunk;
      var topPx = (chunk.origTo > chunk.origFrom ? top : dv.edit.heightAtLine(chunk.editFrom, "local") - sTopEdit);
      if (dv.edit.getScrollerElement().getBoundingClientRect().top < 80) {
        topPx = topPx + 17;
      }
      copy.style.top = topPx + "px";
